...
from transformers import (RobertaConfig, RobertaModel, RobertaTokenizer,
                          BartConfig, BartForConditionalGeneration, BartTokenizer, T5Tokenizer)
import logging
from modeling_t5 import T5Config, T5ForConditionalGeneration
logger = logging.getLogger(__name__)
from modeling_plbart import PLBartForConditionalGeneration, PLBartConfig
...
def build_or_load_gen_model(args):
    ...
    for k in ['attn_mode', 'attn_option', 'attn_composition', 'ffn_mode', 'ffn_option', 'ffn_adapter_layernorm_option',
              'ffn_adapter_init_option', 'ffn_adapter_scalar', 'mid_dim', 'attn_bn', 'ffn_bn', 'prefix_dropout'
              , 'unfreeze_params', 'lora_alpha', 'lora_dropout', 'lora_init']:
    ...
    if args.attn_mode != "none" or args.ffn_mode != "none":
        model = PETLEncDecModel(config, args, model)
