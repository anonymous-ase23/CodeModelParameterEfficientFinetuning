...
def add_args(parser):
    ...
    parser.add_argument("--attn_option", type=str, default='concat')
    parser.add_argument("--attn_composition", type=str, default='add')
    parser.add_argument("--ffn_mode", type=str, default='none')
    parser.add_argument("--ffn_option", type=str, default='none')
    parser.add_argument("--ffn_adapter_layernorm_option", type=str, default='in')
    parser.add_argument("--ffn_adapter_init_option", type=str, default='bert')
    parser.add_argument("--ffn_adapter_scalar", type=str, default='1')
    parser.add_argument("--mid_dim", type=int, default=800)
    parser.add_argument("--attn_bn", type=int, default=200)
    parser.add_argument("--ffn_bn", type=float, default=0.0)
    parser.add_argument("--prefix_dropout", type=float, default=0.0)
    parser.add_argument("--unfreeze_params", type=str, default="ef_")
